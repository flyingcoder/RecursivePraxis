...
- [20_CONTROLLED_RUPTURE_OPERATORS.md](20_CONTROLLED_RUPTURE_OPERATORS.md) — the precise operator/algebra spec
...
| `∅` (collapse attractor) | `"∅"` in `AttractorLabel` | [types.ts](../src/kernel/types.ts) | Uses the formalism's own glyph |
